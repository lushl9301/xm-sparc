...
#define HMLOG_OPCODE_EVENT_MASK (0xffff<<HMLOG_OPCODE_EVENT_BIT) /0xffff0000
#define HMLOG_OPCODE_EVENT_BIT 16

// 256 vcpus
#define HMLOG_OPCODE_VCPUID_MASK (0xff<<HMLOG_OPCODE_VCPUID_BIT) //0x0000ff00
#define HMLOG_OPCODE_VCPUID_BIT 8

// 256 partitions
#define HMLOG_OPCODE_PARTID_MASK (0xff<<HMLOG_OPCODE_PARTID_BIT) //0x000000ff
